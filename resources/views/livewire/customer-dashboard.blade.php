          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div class="lg:col-span-2 space-y-6">
                  ...
                  <div class="bg-white shadow-sm sm:rounded-lg p-6">
                      <h3 class="text-lg font-semibold text-gray-800 mb-4">Servis Terbaru Anda</h3>
                      ...
                      @forelse($myServices as $service)
                          <div class="border-b border-gray-200 pb-4 mb-4">
                              ...
                              <p class="text-sm text-gray-500">
                                  Status: <span class="font-semibold">{{ ucfirst($service->status) }}</span>
                              </p>

                              <p class="text-sm text-gray-500">
                                  Mekanik: {{ $service->mechanic?->name ?? 'Belum Ditentukan' }}
                              </p>

                              <p class="text-sm text-gray-500">
                                  Harga: Rp {{ number_format($service->price ?? 0, 0, ',', '.') }}
                              </p>
                          </div>
                      @empty
              ...
              <div class="space-y-6">
                  <!-- Promo Card -->
                  <div
                      class="bg-gradient-to-r from-[var(--primary)] to-[var(--primary-dark)] text-white overflow-hidden shadow-sm sm:rounded-lg">
                      <div class="p-6">
                          ...
                          <div class="bg-white text-[var(--primary)] text-center py-3 rounded font-bold text-xl mb-4">
                              BBM15</div>
                          <p class="text-xs text-white/70">*Promo berlaku hingga 30 November 2023</p>
                          <a href="https://wa.me/6281234567890" target="_blank"
                              class="mt-4 inline-flex items-center justify-center gap-2 w-full px-4 py-2 rounded-md bg-white text-[var(--primary)] font-semibold hover:bg-gray-100 transition">
                          ...
                          <div class="p-4">
                              <div class="flex">
                                  ...
                                  <div class="ml-4">
                                      ...
                                      <p class="text-sm text-gray-500">Servis Honda Beat Anda diperkirakan selesai
                                          besok.</p>
                          ...
                          <div class="p-4">
                              <div class="flex">
                                  ...
                                  <div class="ml-4">
                                      ...
                                      <p class="text-sm text-gray-500">Anda mendapatkan 25 poin dari servis terakhir.
                                      </p>
