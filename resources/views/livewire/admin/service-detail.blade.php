<div class="max-w-3xl mx-auto bg-white shadow p-6 rounded-lg">
    ...
    <form wire:submit.prevent="updateService" class="space-y-4">
        ...
        <div>
            ...
            <select wire:model.defer="mechanic_id" class="w-full mt-1 border rounded px-3 py-2">
        ...
        <div>
            ...
            <input type="number" wire:model.defer="price" class="w-full border rounded p-2">
        </div>
