    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-gradient-to-r from-[var(--primary)] to-[var(--primary-dark)] text-white">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div>
                        <h3 class="text-2xl font-bold">Selamat Datang, {{ Auth::user()->name ?? 'Mekanik' }}!</h3>
                        <p class="mt-2 text-white/90">Lihat dan kelola servis yang Anda tangani hari ini.</p>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6 flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500">Servis Aktif</dt>
                            <dd>
                                <div class="text-lg font-semibold text-gray-900">{{ $activeServices ?? 0 }}</div>
                            </dd>
                        </dl>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6 flex items-center">
                    <div class="flex-shrink-0 bg-red-100 rounded-md p-3">
                        <i class="fas fa-check text-[var(--primary)] text-xl"></i>
                    </div>
                    <div class="ml-5 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500">Servis Selesai</dt>
                            <dd>
                                <div class="text-lg font-semibold text-gray-900">{{ $completedServices ?? 0 }}</div>
                            </dd>
                        </dl>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6 flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500">Servis Berikutnya</dt>
                            <dd>
                                <div class="text-lg font-semibold text-gray-900">{{ $nextServiceDate ?? '-' }}</div>
                            </dd>
                        </dl>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6 flex items-center">
                    <div class="flex-shrink-0 bg-red-100 rounded-md p-3">
                        <i class="fas fa-bell text-[var(--primary)] text-xl"></i>
                    </div>
                    <div class="ml-5 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500">Notifikasi Baru</dt>
                            <dd>
                                <div class="text-lg font-semibold text-gray-900">{{ $newNotifications ?? 0 }}</div>
                            </dd>
                        </dl>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-800">Servis Anda Saat Ini</h3>
                    </div>
                            ...
                            <div class="p-6 flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Status: <span
                                            class="font-semibold">{{ ucfirst($service->status) }}</span></p>

                                </div>
                                <div class="text-right">
                                    <p class="font-semibold text-[var(--primary)]">Rp
                                        {{ number_format($service->price ?? 0, 0, ',', '.') }}</p>
                                    <a href="{{ route('mechanic.service.detail', $service->id) }}"
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <a href="#"
                                ...
                                <div class="ml-4">
                                    <h4 class="font-medium text-gray-900">Mulai Servis</h4>
                                    <p class="text-sm text-gray-500">Catat progres servis motor</p>
                                </div>
                            </a>
                            ...
                            <a href="#"
                                ...
                                <div class="ml-4">
                                    <h4 class="font-medium text-gray-900">Selesaikan Servis</h4>
                                    <p class="text-sm text-gray-500">Tandai servis yang selesai</p>
                                </div>
                            </a>
                        </div>
                    </div>
